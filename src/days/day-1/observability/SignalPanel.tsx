...
export function SignalPanel({ state, currentEvent }: SignalPanelProps) {
  ...
  return (
    <aside className="signal-panel" aria-labelledby="signal-panel-title">
      ...
      <div className="signal-flow" aria-label="Async request lifecycle">
        ...
        <div className="signal-connector" data-active={requestState === 'active'}>
          <span aria-hidden="true" />
        </div>

        <SignalStage label="Request" step="03" state={requestState}>
        ...
        <div className="signal-branches" aria-label="Response gate outcomes">
          ...
          >
            ...
            <SignalStage label="Render owner" step="05A" state={renderState}>
